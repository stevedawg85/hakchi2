...
namespace com.clusterrr.hakchi_gui
{
    public partial class SelectModsForm : Form
    {
        ...
        public SelectModsForm(bool loadInstalledMods, bool allowDropMods, string[] filesToAdd = null)
        {
            ...
            if (loadInstalledMods && MainForm.sshClientWrapper.IsConnected)
            {
                var modsstr = MainForm.sshClientWrapper.ExecuteSimple("ls /var/lib/hakchi/hmod/uninstall-*", 2000, true);
